<div class="relative isolate px-6 pt-14 lg:px-8">
	...
	>
		<div
			class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-yellow-500 to-orange-500 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
	...
	<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
		<div class="hidden sm:mb-8 sm:flex sm:justify-center">
			...
			>
				<span class="font-semibold text-blue-700">React</span> Playground coming soon.
		...
		<div class="text-center">
			...
			<p class="mt-6 text-lg leading-8 text-gray-600">
				...
				the goal is to have a place to store all my experiments in one place instead of creating a
				new project for every single one.
			</p>
			<div class="mt-10 flex items-center justify-center gap-x-6">
				...
				<a href="https://joaocnh.dev" class="text-sm font-semibold leading-6 text-gray-900">
